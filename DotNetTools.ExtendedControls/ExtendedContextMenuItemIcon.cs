...
{
    public class ExtendedContextMenuItemIcon : MenuItem
    {
        ...
        public static readonly DependencyProperty BackgroundHiglihtedProperty = DependencyProperty.Register(
            nameof(BackgroundHiglihted), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty BackgroundSelectedProperty = DependencyProperty.Register(
            nameof(BackgroundSelected), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty BorderBrushHiglihtedProperty = DependencyProperty.Register(
            nameof(BorderBrushHiglihted), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty BorderBrushSelectedProperty = DependencyProperty.Register(
            nameof(BorderBrushSelected), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty ForegroundHiglihtedProperty = DependencyProperty.Register(
            nameof(ForegroundHiglihted), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty ForegroundSelectedProperty = DependencyProperty.Register(
            nameof(ForegroundSelected), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty GryphlBrushProperty = DependencyProperty.Register(
            nameof(GryphlBrush), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty GryphlBackgroundCheckedProperty = DependencyProperty.Register(
            nameof(GryphlBackgroundChecked), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty GryphlBorderCheckedProperty = DependencyProperty.Register(
            nameof(GryphlBorderChecked), typeof(Brush), typeof(ExtendedContextMenuItemIcon),
            new PropertyMetadata(new SolidColorBrush(GLYPH_BORDER_CHECKED_COLOR_DEFAULT)));


        public static readonly DependencyProperty CornerRadiusProperty = DependencyProperty.Register(
            nameof(CornerRadius), typeof(CornerRadius), typeof(ExtendedContextMenuItemIcon),
            new PropertyMetadata(CORNER_RADIUS_DEFAULT));

        public static readonly DependencyProperty KindProperty = DependencyProperty.Register(
            nameof(Kind), typeof(PackIconKind), typeof(ExtendedContextMenuItemIcon),
        ...
        public static readonly DependencyProperty InteractionBehaviourProperty = DependencyProperty.Register(
            nameof(InteractionBehaviour), typeof(InteractionBehaviour), typeof(ExtendedContextMenuItemIcon),
        ...
        //  --------------------------------------------------------------------------------
        /// <summary> ExtendedContextMenuItemIcon class constructor. </summary>
        public ExtendedContextMenuItemIcon() : base()
        {
            Loaded += ExtendedContextMenuItemIcon_Loaded;
        }

        //  --------------------------------------------------------------------------------
        /// <summary> Static class constructor to override default style. </summary>
        static ExtendedContextMenuItemIcon()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ExtendedContextMenuItemIcon),
                new FrameworkPropertyMetadata(typeof(ExtendedContextMenuItemIcon)));
        }
        ...
        private void ExtendedContextMenuItemIcon_Loaded(object sender, RoutedEventArgs e)
        {
